...
public class RedisDemoTest {
    ...
    public void stockTest(){
        ...
        //5.将用户从已购名单中移除
        //redisService.removeLimitMember(new Long(19), new Long(1234));
    }

    @Test
    public void getStockTest1() {
        String stock = redisService.getValue("stock:19");
        System.out.println(stock);
    }

    @Test
    public void getStockTest2() {
        Jedis jedisClient = jedisPool.getResource();

        //jedisClient.srem("seckillActivity_users:19", "1234");
        Set<String> users = jedisClient.smembers("seckillActivity_users:19");
        jedisClient.close();
